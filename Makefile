# This Makefile is for the Games-Worms-Tk extension to perl.
#
...
#	NAME => q[Games-Worms-Tk]
#	VERSION_FROM => q[lib/Games/Worms/Tk.pm]
...
AR_STATIC_ARGS = cr
NAME = Games-Worms-Tk
DISTNAME = Games-Worms-Tk
NAME_SYM = Games_Worms_Tk
VERSION = 0.41
VERSION_SYM = 0_41
XS_VERSION = 0.41
INST_BIN = ./blib/bin
...
TO_INST_PM = lib/Games/Worms/Base.pm \
...
realclean purge ::  clean
	...
	rm -f $(INST_LIB)/Games/Worms/Tk/Seg.pm $(INST_LIB)/Games/Worms/Node.pm $(INST_LIB)/Games/Worms/Tk/Board.pm $(INST_LIB)/Games/Worms/Tk.pm $(INST_LIB)/Games/Worms/Seg.pm $(INST_LIB)/Games/Worms/Beeler.pm $(INST_LIB)/Games/Worms/Board.pm $(INST_LIB)/Games/Worms/Random.pm $(INST_LIB)/Games/Worms/Base.pm
